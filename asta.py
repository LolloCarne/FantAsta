...
from tkinter import Entry, PhotoImage, Toplevel, ttk,filedialog
from tkinter import messagebox
from tkinter.constants import ANCHOR, E
...
#print(dictJSON)
NUM_PARTECIPANTI=dictJSON["num_partecipanti"]
NOMI_PARTECIPANTI=dictJSON["nomi_partecipanti"]
...
#bottone salvataggio
bottone_salvataggio=tk.Button(root,text="Salva Asta",bd=3,width=20,bg=second_color,relief="raised",fg=main_color,borderwidth=0,height=2,command=salva)
bottone_salvataggio.grid(column=0,row=8,padx=20,pady=50)
